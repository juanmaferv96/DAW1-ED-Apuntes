...
- El **disco duro** se considera un perifercio de E/S (Entrada/Salida).
- La **CPU** se llama tambien ***UCP*** en *Inglés*. Es el procesador o microprocesor.
...
***Predictivo**: Planificar. Decir lo que pasará en un futuro.
...
### Proceso de compilación/interhttps://github.com/juanmaferv96/DAW1-ED-Apuntes.gitpretación
